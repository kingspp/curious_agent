    ...
    def __init__(self, fp, args):
        self.episode_template = namedtuple('EpisodeData',
                                           (
                                               ...
                                               "lr", "intr_reward"))
        self.step_template = namedtuple('StepData', ("step", "epsilon", "reward", "max_q", "loss", "lr", "intr_reward"))
        self.fp = fp
    ...
    def update_episode(self, *args):
        ...
        if self.episode_data.episode % self.args.disp_freq == 0:
            logger.info(
                ...
                f"| INTR: {self.episode_data.intr_reward:.2f} | MAQ:{self.episode_data.max_avg_q:.2f} "
        ...
        if MODULE_CONFIG.BaseConfig.TENSORBOARD_SUMMARIES:
            ...
            self.writer.add_scalar('episode/intr_reward', self.episode_data.intr_reward, self.step_data.step)
