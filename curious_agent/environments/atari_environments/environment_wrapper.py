...
.. module:: visualizer
    :platform: Linux
    :synopsis: atari-wrapper utilities from OpenAi
    :source: https://github.com/huiminren/DS595CS525-RL-HW/blob/master/project3/environment.py
    :note: some changes were made to reflect the new state of the OpenAi repo
"""
import gym
import numpy as np
...
class EnvironmentWrapper(object):
    def __init__(self, env_name, atari_wrapper=False, test=False):
        if atari_wrapper:
            ...
            self.env = make_atari(env_name, clip_rewards)
        else:
